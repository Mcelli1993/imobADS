...
<body>
  <section class="menu cid-qxXgS3JcCF" once="menu" id="menu1-1m" data-rv-view="352">
  ...
  <section class="engine">
    <a href="https://mobirise.co/f">free bootstrap builder</a>
  </section>
    ...
    <div class="container container-table">
      ...
      <div class="table-wrapper">
          ...
          <table class="table isSearch" cellspacing="0">
            <thead>
              <tr class="table-heads ">
                ...
                <th class="head-item mbr-fonts-style display-7">Salário</th>
              </tr>
            </thead>
            <tbody>
              <tr>
              ...
              <tr>
                ...
                <td class="body-item mbr-fonts-style display-7">$400</td>
        ...
        <div class="container table-info-container">
          <div class="row info">
            <div class="col-md-6">
              <div class="dataTables_info mbr-fonts-style display-7"></div>
            </div>
            <div class="col-md-6"></div>
          </div>
        </div>
