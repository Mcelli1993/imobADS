...
$sql = "select * from vendas limit ".$start.",".$perPage." ";
$total = $db->query("select * from vendas")->num_rows;
        ...
        <table class="table isSearch table-bordered bg-secondary" cellspacing="0">
          ...
          <?php while($row = $rows->fetch_assoc()){ ?>
            <tr>
              ...
              <td class="body-item mbr-fonts-style display-7"><?php echo $row['funcionario_id']; ?></td>
              <td class="body-item mbr-fonts-style display-7"><?php echo $row['comissao']; ?></td>
              <td class="body-item mbr-fonts-style display-7"><?php echo $row['valor']; ?></td>
              <td>
                <a class="nav-link text-center" href="updateVendas.php?editar=<?php echo $row['id'];?>">ALTERAR</a>
              </td>
              <td>
                <a class="nav-link text-center" href="deleteVendas.php?excluir=<?php echo $row['id'];?>">EXCLUIR</a>
              </td>
            </tr>
            <tr></tr>
            <tr></tr>
